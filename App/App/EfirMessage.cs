...
namespace App
{
    public partial class EfirAppeals : Form
    {
        ...
        public void formedQuer(object sender, EventArgs e)
        {
            ...
            // cmd.Connection = connection;
            connection.Open();
            string sql = "SELECT         [user].*,messages.message_text, popular_group.[content], messages.datatime, message_categories.message_categories, status_message.status_message "+
